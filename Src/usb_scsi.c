...
void SCSI_ReadFormatCapacity_Cmd(uint8_t lun)
{
  ...
  memset(ReadFormatCapacity_Data, 0, READ_FORMAT_CAPACITY_DATA_LEN);
  
  ReadFormatCapacity_Data[3] = 0x08;
  ReadFormatCapacity_Data[4] = (uint8_t)((Mass_Block_Count[lun] - 1) >> 24);
  ReadFormatCapacity_Data[5] = (uint8_t)((Mass_Block_Count[lun] - 1) >> 16);
  ReadFormatCapacity_Data[6] = (uint8_t)((Mass_Block_Count[lun] - 1) >>  8);
  ReadFormatCapacity_Data[7] = (uint8_t)(Mass_Block_Count[lun] - 1);
